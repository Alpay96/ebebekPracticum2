...
public class Student {
    ...
    public void printNote() {
        ...
        System.out.println("Matematik : Sınav notu: " + this.mat.note + " -- Sözlü notu: " + this.mat.verbalNote + "\tOranlar ==> sınav %80  sözlü %20");
        System.out.println("Fizik     : sınav notu: " + this.fizik.note + " -- Sözlü notu: " + this.fizik.verbalNote + "\tOranlar ==> sınav %75  sözlü %25");
        System.out.println("Kimya     : sınav notu: " + this.kimya.note + " -- Sözlü notu: " + this.kimya.verbalNote + "\tOranlar ==> sınav %60  sözlü %40");
    }
}
